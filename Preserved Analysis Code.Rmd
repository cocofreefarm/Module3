...
grade <- rep("lower",5)
lower.freq.dat <- type.convert(as.data.frame(cbind(grade,stars,freq.lower.mat)))
lower.freq.dat$stars <- as.factor(lower.freq.dat$stars)

grade <- rep("better",5)
better.freq.dat <- type.convert(as.data.frame(cbind(grade,stars,freq.higher.mat)))
better.freq.dat$stars <- as.factor(better.freq.dat$stars)
...
lower.star3 <-length(which(freq.lower.dat[,1] == 3 t& freq.lower.dat[,2] == 1))
...
```{r}
t.test(lowerhotel.dat[,"booked"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"booked"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"money"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"money"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"staff"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"staff"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"manager"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"manager"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"breakfast"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"breakfast"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"desk"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"desk"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"wall"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"wall"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"toilet"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"toilet"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"parking"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"parking"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"bar"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"bar"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"downtown"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"downtown"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"restaurant"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"restaurant"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"location"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"location"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"clean"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"clean"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"comfortable"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"comfortable"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"spacious"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"spacious"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"quiet"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"quiet"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"smell"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"smell"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"modern"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"modern"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"pretty"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"pretty"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"comfy"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"comfy"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
t.test(lowerhotel.dat[,"dirty"][which(lowerhotel.dat$stars == 4 | lowerhotel.dat$stars == 5)], betterhotel.dat[,"dirty"][which(betterhotel.dat$stars == 4 |betterhotel.dat$stars == 5)])
```
```{r}
t.test(better.freq.dat$booked[1:2],lower.freq.dat$booked[1:2],paired=T)
t.test(better.freq.dat$money[1:2],lower.freq.dat$money[1:2],paired=T)
t.test(better.freq.dat$staff[1:2],lower.freq.dat$staff[1:2],paired=T)
t.test(better.freq.dat$manager[1:2],lower.freq.dat$manager[1:2],paired=T)
t.test(better.freq.dat$breakfast[1:2],lower.freq.dat$breakfast[1:2],paired=T)
t.test(better.freq.dat$desk[1:2],lower.freq.dat$desk[1:2],paired=T)
t.test(better.freq.dat$wall[1:2],lower.freq.dat$wall[1:2],paired=T)
t.test(better.freq.dat$toilet[1:2],lower.freq.dat$toilet[1:2],paired=T)
t.test(better.freq.dat$parking[1:2],lower.freq.dat$parking[1:2],paired=T)
t.test(better.freq.dat$bar[1:2],lower.freq.dat$bar[1:2],paired=T)
t.test(better.freq.dat$downtown[1:2],lower.freq.dat$downtown[1:2],paired=T)
t.test(better.freq.dat$restaurant[1:2],lower.freq.dat$restaurant[1:2],paired=T)
t.test(better.freq.dat$location[1:2],lower.freq.dat$location[1:2],paired=T)
t.test(better.freq.dat$clean[1:2],lower.freq.dat$clean[1:2],paired=T)
t.test(better.freq.dat$comfortable[1:2],lower.freq.dat$comfortable[1:2],paired=T)
t.test(better.freq.dat$spacious[1:2],lower.freq.dat$spacious[1:2],paired=T)
t.test(better.freq.dat$quiet[1:2],lower.freq.dat$quiet[1:2],paired=T)
t.test(better.freq.dat$smell[1:2],lower.freq.dat$smell[1:2],paired=T)
t.test(better.freq.dat$modern[1:2],lower.freq.dat$modern[1:2],paired=T)
t.test(better.freq.dat$pretty[1:2],lower.freq.dat$pretty[1:2],paired=T)
t.test(better.freq.dat$comfy[1:2],lower.freq.dat$comfy[1:2],paired=T)
t.test(better.freq.dat$dirty[1:2],lower.freq.dat$dirty[1:2],paired=T)
```
...
```{r}
#porportion function
test.ac.proportion <- function(star,argument1){
ind <- argument1
total.ac.star1 <-length(which(ac.dat$stars == 1))
total.ac.star2 <-length(which(ac.dat$stars == 2))
total.ac.star3 <-length(which(ac.dat$stars == 3))
total.ac.star4 <-length(which(ac.dat$stars == 4))
total.ac.star5 <-length(which(ac.dat$stars == 5))
total.ac.v <- c(total.ac.star1,total.ac.star2,total.ac.star3,total.ac.star4,total.ac.star5)

freq.ac.dat <- cbind(ac.dat$stars, ac.dat[,ind])
ac.star1 <-length(which(freq.ac.dat[,1] == 1 & freq.ac.dat[,2] == 1))
ac.star2 <-length(which(freq.ac.dat[,1] == 2 & freq.ac.dat[,2] == 1))
ac.star3 <-length(which(freq.ac.dat[,1] == 3 & freq.ac.dat[,2] == 1))
ac.star4 <-length(which(freq.ac.dat[,1] == 4 & freq.ac.dat[,2] == 1))
ac.star5 <-length(which(freq.ac.dat[,1] == 5 & freq.ac.dat[,2] == 1))
ac.v <- c(ac.star1, ac.star2, ac.star3, ac.star4, ac.star5)

ac.dat <- cbind(ac.v,total.ac.v)
...
prop.test(x=c(ac.dat[star,1],better.dat[star,1]),n=c(ac.dat[star,2],better.dat[star,2]))
}
```

```{r}
test.dat <- wordembedding.dat[c("stars","booked","money","staff", "manager", "breakfast", "desk","wall","toilet","parking","bar","downtown","restaurant","location","clean","comfortable","spacious","quiet","smell","modern","pretty","comfy","dirty")]
