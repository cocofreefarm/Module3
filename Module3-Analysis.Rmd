...
plot(avg.hotel, ylab="Average Hotel Rate")
review.len <- c()
...
dat$stars_x[which(dat$name==names(avg.hotel)[2])]

dat$stars_x[which(dat$name==names(avg.hotel)[3])]
dat$stars_x[which(dat$name==names(avg.hotel)[4])]
dat$stars_x[which(dat$name==names(avg.hotel)[5])]
dat$stars_x[which(dat$name==names(avg.hotel)[6])]
dat$stars_x[which(dat$name==names(avg.hotel)[7])]
```
